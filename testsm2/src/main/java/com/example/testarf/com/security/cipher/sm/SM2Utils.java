...
import com.example.testarf.MainActivity;
...
public class SM2Utils 
{
	...
	public static byte[] encrypt(byte[] publicKey, byte[] data) throws IOException
	{
		...
		Log.i(MainActivity.TAG,"加密后的数据-----"+ Util.byteToHex(result));
		return result;
	}
	...
	public static byte[] decrypt(byte[] privateKey, byte[] encryptedData) throws IOException
	{
		...
		byte[] c3 = new byte[32];
		cipher.Dofinal(c3);
		Log.i(MainActivity.TAG,"解密后的数据-----"+ Util.byteToHex(enc));
		return enc;
	}
	...
	public static byte[] sign(byte[] userId, byte[] privateKey, byte[] sourceData) throws IOException
	{
		...
		Log.i(MainActivity.TAG,"椭圆曲线点X-----"+userKey.getX().toBigInteger().toString(16));
		Log.i(MainActivity.TAG,"椭圆曲线点Y-----"+userKey.getY().toBigInteger().toString(16));
...
//		System.out.println("");
		...
		System.out.println("SM3??Z: " + Util.getHexString(z));
	    System.out.println("");
		...
		Log.i(MainActivity.TAG,"SM3摘要值-----"+Util.getHexString(md));
//		System.out.println("SM3摘要值: " + Util.getHexString(md));
//	    System.out.println("");
	    
	    SM2Result sm2Result = new SM2Result();
	    sm2.sm2Sign(md, userD, userKey, sm2Result);
		Log.i(MainActivity.TAG,"r-----"+sm2Result.r.toString(16));
		Log.i(MainActivity.TAG,"s-----"+sm2Result.s.toString(16));
...
//	    System.out.println("");
	    ...
	    Log.i(MainActivity.TAG,"生成的签名值------"+Util.byteToHex(signdata));
		return signdata;
	}
...
//	    System.out.println("");
	    ...
	    Log.i(MainActivity.TAG,"验签r-----"+sm2Result.r);
	    Log.i(MainActivity.TAG,"验签R-----"+sm2Result.R);
...
//		String prik = "128B2FA8BD433C6C068C8D803DFF79792A519A55171B1B650C23661D15897263";
		String prik = com.example.testarf.smutil.SM2Utils.sm2PrivateKey;
		...
		Log.i(MainActivity.TAG,"生成的签名证书----"+Util.getHexString(c));
...
//		String pubk = "040AE4C7798AA0F119471BEE11825BE46202BB79E2A5844495E97C04FF4DF2548A7C0240F88F1CD4E16352A73C17B7F16F07353E53A176D684A9FE0C6BB798E857";
		String pubk = com.example.testarf.smutil.SM2Utils.sm2PubliKey;
...
//		System.out.println("解密: ");
		...
		Log.i(MainActivity.TAG,"解密后的数据----"+plainText);
