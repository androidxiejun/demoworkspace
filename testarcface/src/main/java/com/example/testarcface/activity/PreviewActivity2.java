...
public class PreviewActivity2 extends AppCompatActivity implements ViewTreeObserver.OnGlobalLayoutListener {
...
//                    int code =0;
                    ...
                    Log.i(TAG, "ageCode----------" + ageCode);
                    Log.i(TAG, "genderCode----------" + genderCode);
                    Log.i(TAG, "face3DAngleCode----------" + face3DAngleCode);
                    Log.i(TAG, "livenessCode----------" + livenessCode);
